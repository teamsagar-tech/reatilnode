...
function refactorFile(filePath) {
    ...
    const startStr = `<div className='flex flex-1 gap-6 overflow-hidden'>`;
    const endStr = `{/* Action Buttons */}`;
    ...
    const newBlock = `                  <div className='flex flex-col flex-1 gap-4 overflow-y-auto pb-4 custom-scrollbar pr-2'>
                    {/* Top Row */}
                      ...
                      <div className="w-2/3 flex flex-col border-r-2 border-slate-300 pr-4">
                        ...
                        <div className="flex w-full gap-6 mt-1">
                          ...
                          <div className="w-1/2 flex flex-col gap-1">
                            ...
                            <InputRow label="Opening Bal" value={formData.openingBalance || 0} onChange={(v) => setFormData({...formData, openingBalance: Number(v) || 0})} />
                          </div>
                    ...
                    <div className="flex w-full gap-6 border-t-2 border-slate-300 pt-2 mt-2">
                      ...
                      <div className="w-1/3 flex flex-col gap-1 border-r-2 border-slate-300 pr-4">
                        ...
                        <InputRow label="Contact Person" value={formData.contactPerson} onChange={(v) => setFormData({...formData, contactPerson: v})} />
                        <InputRow label="Mobile Number" value={formData.mobileNumber} onChange={(v) => setFormData({...formData, mobileNumber: v})} />
                        <InputRow label="Contact Person 2" value={formData.contactNumber2} onChange={(v) => setFormData({...formData, contactNumber2: v})} />
                        <InputRow label="Mobile Number 2" value={formData.mobileNumber2} onChange={(v) => setFormData({...formData, mobileNumber2: v})} />
                        <InputRow label="Contact Person 3" value={formData.contactNumber3} onChange={(v) => setFormData({...formData, contactNumber3: v})} />
                        <InputRow label="Mobile Number 3" value={formData.mobileNumber3} onChange={(v) => setFormData({...formData, mobileNumber3: v})} />
                      </div>
...
refactorFile(path.join(basePath, 'pages/masters/accounting/PartyMaster.tsx'));
