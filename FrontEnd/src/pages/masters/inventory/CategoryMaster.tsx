...
export default function CategoryMaster() {
  ...
  const sampleData = [
    ...
    { id: 2, name: 'Clothing', description: 'Apparel and Fashion', status: 'Inactive' },
    { id: 3, name: 'Groceries', description: 'Food and Consumables', status: 'Active' },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Category Master | RetailNode</title>
      </Helmet>
      ...
      <div className='flex flex-col h-[calc(100vh-6rem)] font-sans selection:bg-indigo-100 w-full max-w-[1400px] mx-auto'>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-black text-slate-800 tracking-tight">Category Master</h1>
            ...
            <div className='p-4 sm:p-6 flex-1 overflow-y-auto flex flex-col'>
              {mode === 'list' ? (
                ...
                <div className='flex flex-col h-full overflow-hidden'>
                  {/* Premium Tally-style Layout (Single Column for Category) */}
                  <div className='flex flex-1 gap-6 overflow-hidden'>
                    ...
                    <div className="flex-1 flex flex-col gap-1 overflow-y-auto pb-4 custom-scrollbar">
                      ...
                      <InputRow id="field-0" label="Category Name" value={formData.categoryName} onChange={(v: string) => setFormData({...formData, categoryName: v})} />
                      <InputRow label="Department" value={formData.department} onChange={(v: string) => setFormData({...formData, department: v})} />
                    </div>
